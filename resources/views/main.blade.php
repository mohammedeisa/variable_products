...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('css/variable_products.css') }}" rel="stylesheet">
                                ...
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-home"></i> Products <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <li><a href="{{url('/product/create' )}}">New</a></li>
                                            <li><a href="{{url('/attribute' )}}">Attributes</a></li>
                                            <li><a href="index2.html">Configurations</a></li>                                            
                                        </ul>
                                    </li>
                            ...
                            <ul class=" navbar-right">
                                <li class="nav-item dropdown open" style="padding-left: 15px;">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                                        <img src="images/img.jpg" alt="">Mohammed Eisa
                                    </a>
...
var delete_variation_url = '{{url("/product/delete_variation")}}';
    ...
    <script src="{{ asset('/js/variable_products.js') }}"></script>
</body>               
</html>